...
def Ensemble (uncertainty_reward=None, device=None, envs=None,\
    ...
    ensemble_file_name = f'ensemble_{env_name}_n={ensemble_size}_hu={ensemble_hidden_size}_d={args.distribution}_' \
                         f'policy_ntrajs={num_trajs}_seed={seed}'
    ...
    print('*'*50)
    print(f'\n Checking if model already exist: {ensemble_model_path}\n')
    print('*' * 50)
