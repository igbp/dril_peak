...
def get_args():
    ...
    parser.add_argument(
        '--ensemble_batch_size', type=int, default=1000,
        help='dril ensemble training batch size (default: 1000)')
    parser.add_argument(
    ...
    parser.add_argument(
        '--distribution',
        default='beta',
        help='back end exploratory distribution used (default: gaussian ["beta", "gaussian"])')
    ...
    if args.default_experiment_params != 'None':
        ...
        if args.default_experiment_params == 'continous-control':
            ...
            args.num_dril_bc_train_epoch = 1 * 5
